...
이 도구는 아래 링크를 통해 설치 없이 웹에서 바로 사용해볼 수 있습니다.

▶ 여기를 클릭하여 라이브 데모 실행하기
...
<body class="bg-gray-50 text-gray-800">
    ...
    <div class="container mx-auto p-4 sm:p-6 lg:p-8 max-w-7xl">
        ...
        <main>
            ...
            <div class="bg-white p-6 rounded-lg shadow-md mb-8">
                ...
                <textarea id="channel-data" rows="8" class="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition" placeholder="예: contact@example.com..."></textarea>
                <div class="mt-4 flex flex-col sm:flex-row gap-4">
                    ...
                    <button id="clear-all-btn" onclick="openClearAllModal()" class="w-full sm:w-auto bg-red-600 text-white font-bold py-2 px-6 rounded-md hover:bg-red-700 transition duration-300 hidden">
                        전체 삭제
                    </button>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-x-auto">
                ...
                <p id="empty-table-message" class="p-8 text-center text-gray-500">아직 추가된 채널이 없습니다.</p>
            </div>
        </main>
    </div>
    ...
    <script>
        ...
        function addChannelToTable(data) {
            ...
            newRow.innerHTML = `
                ...
                <td class="table-cell text-center">
                    <button onclick="deleteRow(this)" class="text-gray-400 hover:text-red-600 font-bold text-xl px-2 py-1 transition-colors">&times;</button>
                </td>
            `;
        ...
        function createLink(text, url) {
            ...
            return `<a href="${cleanUrl}" target="_blank" class="text-blue-600 hover:underline hover:text-blue-800 break-all">${cleanText}</a>`;
        }
        ...
        function updateTableVisibility() {
            ...
            document.getElementById('export-csv').style.display = isEmpty ? 'none' : 'inline-block';
            document.getElementById('clear-all-btn').style.display = isEmpty ? 'none' : 'inline-block';
        }
        ...
        function exportToCSV() {
            ...
            for (let i = 1; i < table.rows.length; i++) {
                ...
                row.push(`"${cols[1].querySelector('a') ? cols[1].querySelector('a').href : cols[1].innerText}"`);
